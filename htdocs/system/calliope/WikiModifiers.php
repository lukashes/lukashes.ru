<?
  ...
  class WikiServices
  {
     ...
     */
     ...
     /**
     * Метод делает implode у массива и отсекает пустое окончание
     */
     ...
     /**
     * Проверяет строку на наличие внедренного JavaScript кода, эта функция создана для исправления ряда
     * багов, найденных в Calliope Кукуцем, за что ему, большое спасибо.
     **/
